...
analysisWithLowReplicates.pl -A pooled_ac_nuc_vcp/IRFinder-IR-dir.txt ac_nuc_cb1e/IRFinder-IR-dir.txt ac_nuc_glia/IRFinder-IR-dir.txt -B pooled_ac_nuc_ctrl/IRFinder-IR-dir.txt ac_nuc_ctrl1/IRFinder-IR-dir.txt ac_nuc_ctrl5/IRFinder-IR-dir.txt > ac_nuc_vcp-vs-ctrl.txt
